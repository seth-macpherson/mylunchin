...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.md", "README.md", "Rakefile", "multi_json.gemspec", "Gemfile", ".document", ".rspec", ".travis.yml", "spec/helper.rb", "spec/multi_json_spec.rb", "lib/multi_json/engines/json_common.rb", "lib/multi_json/engines/json_gem.rb", "lib/multi_json/engines/json_pure.rb", "lib/multi_json/engines/nsjsonserialization.rb", "lib/multi_json/engines/ok_json.rb", "lib/multi_json/engines/yajl.rb", "lib/multi_json/vendor/ok_json.rb", "lib/multi_json/version.rb", "lib/multi_json.rb"]
